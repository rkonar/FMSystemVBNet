Public Class frmShowFlatDetails
        ...
        With dgvControl
            ...
            For tmpR = 17 To 1 Step -1
                ...
                For tmpC = 0 To 3
                    ...
                    If gFlats.allFlats(tmpIndx).isOnTenancy <> -1 Then

                        .Rows(curR).Cells(tmpC).Style.BackColor = Color.Black
                        .Rows(curR).Cells(tmpC).Style.ForeColor = Color.Goldenrod
                        .Rows(curR).Cells(tmpC).Value = .Rows(curR).Cells(tmpC).Value & vbNewLine & "Compliance:" & vbNewLine & gFlats.allFlats(tmpIndx).isOnTenancy & " / 6"
            ...
            'tmpRS = gcon.Execute("select * from tbltenants where (TenancyEndDate is null or TenancyEndDate >=" & DateTime.Now.ToString(DB_DATEFORMAT) & ") order by FlatCode"
...
errH:
    ...
    Private Sub frmShowFlatDetails_Load(sender As Object, e As EventArgs) Handles MyBase.Load
        loadAllTowers("")
