Public Class frmJournalBankStatement
...
errH:
    ...
    Private Sub frmJournalBankStatement_Load(sender As System.Object, e As System.EventArgs) Handles MyBase.Load
        resetFields()
    End Sub
    ...
    Sub PopulateJournal_b()
        ...
        If myLeft(cboTxnType.Text, 7) = "BANK-2-" Then
            journalQuerySQL = "select * from tbljournal where DrAmount=0 "
            If cboCreditAccount.Text <> "" Then
                journalQuerySQL = journalQuerySQL & " and AccountNo='" & cboCreditAccount.Text & "'"
            End If
        Else
            journalQuerySQL = "select * from tbljournal where CrAmount=0 "
            If cboDebitAccount.Text <> "" Then
...
errH:
    ...
    Private Sub btnAddBankCharge_Click(sender As Object, e As EventArgs) Handles btnAddBankCharge.Click
        ...
        frmManagePayment.ShowDialog()
        frmManagePayment.Dispose()
        gAllowBankChargeEntryOnly = False
    End Sub

    Private Sub btnLoadTDAccountsInCrCombo_Click(sender As Object, e As EventArgs) Handles btnLoadTDAccountsInCrCombo.Click
        loadTDBankAccounts("CR")
    End Sub

    Private Sub btnLoadTDAccountsInDrCombo_Click(sender As Object, e As EventArgs) Handles btnLoadTDAccountsInDrCombo.Click
        loadTDBankAccounts("DR")
    End Sub
