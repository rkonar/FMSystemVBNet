Public Class frmViewReceipt
    ...
    Private Sub btnSave_Click(sender As System.Object, e As System.EventArgs) Handles btnSave.Click
        ...
        With thisReceipt
            ...
            If txtrefgid.Text = "-" Or txtrefgid.Text = "" Then 'for cases when updating instrument type for non-reconciled receipts from CASH TO CHEQUE/ONLINE or Vice-Versa
                ssql = "update tblreceipt set refgid="
                If cboInstrumentType.Text = "CASH" Then
                    ssql = ssql & "-"
                Else
                    ssql = ssql & "null"
                End If
                ssql = ssql & " where gid='" & txtgid.Text & "'"
                gcon.Execute(ssql)

                ssql = "update tbljournal set refgid="
                If cboInstrumentType.Text = "CASH" Then
                    ssql = ssql & "-"
                Else
                    ssql = ssql & "null"
...
errH:
    ...
    Function validateReceiptUpdate() As Boolean
        ...
        'ssql = "select * from tblreceipt where ReceiptNo='" & Trim(txtReceiptNo.Text) & "'"
    ...
    Sub controlFieldStatus(makeEditable As Boolean)
        ...
        Else
            ...
            If txtrefgid.Text = "" Or txtrefgid.Text = "-" Then ' Update of Instrument Type is allowed only for Unreconciled entries
                If gLoginID = "sa" Then
                    txtReceiptAmount.Enabled = True
                    cboInstrumentType.Enabled = True
                    dtpInstrumentDate.Enabled = True
                    txtInstrumentNo.Enabled = True
                    cboBankName.Enabled = True
                End If
    ...
    Private Sub frmViewReceipt_Load(sender As System.Object, e As System.EventArgs) Handles MyBase.Load
        'gItemCode = "Receipts"
