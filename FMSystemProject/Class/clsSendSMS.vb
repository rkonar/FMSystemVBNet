Public Class clsSendSMS
    ...
    Public Function sendSMS() As Boolean
        ...
        If receipientNo = "" Then
            logError("Error in clsSendSMS.sendSMS(): SMS was not sent because :No number registered", "Number:" & receipientNo, "Message:" & msg, "", "")
            MsgBox("SMS was not sent because :No number registered")
            Exit Function
        End If

        If IsNumeric(receipientNo) = False Then
            logError("Error in clsSendSMS.sendSMS(): SMS was not sent because :Invalid number", "Number:" & receipientNo, "Message:" & msg, "", "")
        ...
        If InStr(UCase(strResp), "STATUS=0") = 0 Then
            logError("Error in clsSendSMS.DoWebRequest(): SMS was not sent because: " & strResp, "Number:" & receipientNo, "Message:" & msg, "", "")
...
errH:
        ...
        logError("Error in clsSendSMS.DoWebRequest(): " & tmpErrDesc, "Number:" & receipientNo, "Message:" & msg, "", "")
        MsgBox(tmpErrDesc)
    End Function
...
errH:
        tmpErrDesc = Err.Description
        logError("Error in clsSendSMS.DoWebRequest(): " & tmpErrDesc, "Number:" & receipientNo, "Message:" & msg, "Response Code:" & strResp, "")
        MsgBox(tmpErrDesc)
        Exit Function
    End Function
...
errH:
        ...
        If chkPoint = False Then
            logError("Error in clsSendSMS.sendSMS4Receipt(): " & thisErr, "Number:" & receipientNo, "ReceiptNo:" & rcpt_no, "Flat:" & myReceipt.FlatCode, "")
        End If
...
errH:
        ...
        MsgBox(thisErr)
        If chkPoint = False Then
            logError("Error in clsSendSMS.sendSMS4Bill(): " & thisErr, "Number:" & receipientNo, "BillNo:" & billNo, "Flat:" & flatCode, "")
        End If
    End Function
...
errH:
        ...
        MsgBox(thisErr)
        If chkPoint = False Then
            logError("Error in clsSendSMS.sendSMS4Case(): " & thisErr, "Number:" & receipientNo, "CaseNo:" & case_no, "Flat:" & tmpflatcode, "")
        End If
...
errH:
        ...
        MsgBox(thisErr)
        If chkPoint = False Then
            logError("Error in clsSendSMS.sendSMS4Reminder(): " & thisErr, "Number:" & receipientNo, "MsgType:" & msgType, "Flat:" & flatCode, "")
        End If
    End Function
End Class
